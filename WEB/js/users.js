(function() {
    ...
    async function loadUsers() {
      ...
      try {
        ...
        if (!response.ok) {
          console.error("HTTP error fetching users:", response.status);
          return;
        }
    ...
    function viewUser(userId) {
      ...
      const yearLevelInput = modal.querySelector("#yearLevel");
      if (yearLevelInput) yearLevelInput.value = user.year_level || "";
      const blockInput = modal.querySelector("#block");
      if (blockInput) blockInput.value = user.block || "";
      const admissionYearInput = modal.querySelector("#admissionYear");
      if (admissionYearInput) admissionYearInput.value = user.admission_year || "";
     ...
     * Now includes the password field.
     */
