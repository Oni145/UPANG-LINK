    ...
    class RequirementNoteController {
        ...
        private function create() {
            ...
            if ($result && $result['count'] > 0) {
                ...
                echo json_encode([
                    "status" => "error",
                    "message" => "A requirement note for this request already exists. Please update the existing note if needed."
                ]);
                return;
            }
        ...
        // Expects a JSON payload with at least the note_id and the updated note.
        ...
        // Otherwise, fetch all created notes (and do not include requirement_name).
        private function get() {
            try {
                ...
                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    // Remove the requirement_name field from the output.
