...
// Now test the get_student_details.php endpoint
echo "Step 2: Testing get_student_details.php endpoint...\n";

// Test configuration
$api_url = "http://localhost/UPANG-LINK/UPANG%20LINK%20API/api/get_student_details.php";
